...
<main class="poster">
  ...
  <h1>Only iPhone<br>can do.</h1>
  <p class="sub">很 iPhone。</p>
  <p class="desc">这份资料，为 iPhone 独占打造。<br>系统已确认您正在使用 iPhone，即刻尽享全部内容。</p>
  <a class="cta" href="https://www.apple.com.cn/">进一步了解</a>
</main>
